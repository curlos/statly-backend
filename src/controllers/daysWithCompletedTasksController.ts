 ...
 */
export async function getDaysWithCompletedTasksHandler(req: CustomRequest, res: Response) {
	try {
		...
		const result = await getDaysWithCompletedTasks(queryParams, userId);
 ...
 */
export async function exportDaysWithCompletedTasksHandler(req: CustomRequest, res: Response) {
	try {
		// Parse query parameters
		...
		const result = await exportDaysWithCompletedTasks(queryParams, userId);
